...
import style from "../Styles/ScheduleDetaill.module.css";
  ...
  render() {
    return (
      ...
      <CardBody>
        ...
        <CardTitle>Price : {this.props.schedule.price}</CardTitle>
        ...
        <button className={"no-focusborder"} onClick={this.handelDeleteSchedule} >Delete Schedule</button>
...
export default connect(mapStateProp, {singleSchedule, addCartAction, fetchSchdule, deleteScheduleAdmin, updateScheduleAdminAction })(ScheduletDetaill);
